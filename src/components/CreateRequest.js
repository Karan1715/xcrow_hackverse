      ...
      <Row>
        <Col span={16}>
          <div className="create-form white boxed">
            <h2>Create new Xcrows</h2>
            <br />

            <h3 className="vertical-margin">Xcrows Agreement title:</h3>
            <Input
            ...
            />
             <h3 className="vertical-margin">Declaration note:</h3>
            <TextArea
            ...
            <h3 className="vertical-margin">Upload Edoc/Notary scan copy:</h3>
            <FileDrop
              files={data.files}
            ...
            <p>
             Party 2 of this transaction for whom the service/product done in return of XDC
            </p>
            <Input
              placeholder="Wallet address of signer"
              value={data.signerAddress}
              prefix="Receiptant Address:"
